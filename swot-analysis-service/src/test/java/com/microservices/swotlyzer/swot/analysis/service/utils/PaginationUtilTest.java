...
public class PaginationUtilTest {
  ...
  void itShouldBuildAPaginationResponse() {
    ...
    SwotAnalysis thirdtSwot = GenerateSwotAnalysis.generateSwotAnalysis(
      1L,
      "3"
    );
    var totalPages = 3;
    var currentPage = 0;
    var pageSize = 3;
    PaginationResponse<SwotAnalysis> paginationResponse = underTest.buildResponse(
  ...
  void itShouldPaginateAll() {
    ...
    SwotAnalysis fourthSwot = GenerateSwotAnalysis.generateSwotAnalysis(
      1L,
      "4"
    );
    ...
    SwotAnalysis seventhtSwot = GenerateSwotAnalysis.generateSwotAnalysis(
      1L,
      "7"
    );
    swotAnalysisRepository.saveAll(
      List.of(
        firstSwot,
        secondSwot,
        thirdtSwot,
    ...
    // 0==1
    PaginationResponse<SwotAnalysis> paginationResponse = underTest.paginateAll(
      0,
      5,
