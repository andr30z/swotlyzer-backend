package com.microservices.swotlyzer.api.core.configs;

import com.microservices.swotlyzer.api.core.services.impl.CustomUserDetailsServiceImpl;
import com.microservices.swotlyzer.api.core.services.TokenProvider;
import com.microservices.swotlyzer.api.core.utils.SecurityCipher;
        ...
        for (Cookie cookie : cookies) {
            if (accessTokenCookieName.equals(cookie.getName())) {
                ...
                return accessToken == null ?
                        null :
                        SecurityCipher.decrypt(accessToken);
            }
        }
        return null;
    }
